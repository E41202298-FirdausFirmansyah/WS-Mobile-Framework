import 'package:minggu10_2/data/api_provider.dart';
...
class _HomeState extends State<Home> {
                      ...
                      Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (context) => MovieDetail(
                                movie: snapshot.data.results[index], key: null,
                              ))
                      );
                    }
                );
  ...
  Widget moviesItem({required String poster, required String title, required String date, required String voteAverage, required VoidCallback onTap}) {
    return InkWell(
      onTap: onTap,
      child: Container(
